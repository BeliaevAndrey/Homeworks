...
# * Создайте HTML шаблон для отображения списка пользователей. Шаблон должен содержать заголовок
#   страницы, таблицу со списком пользователей и кнопку для добавления нового пользователя.
...
if __name__ == "__main__":
    uvicorn.run(
        "task06:app",  # Update "task2:app" to the correct module name
        host="127.0.0.1",
        port=8000,
        reload=True,
    )
